...
async function runMultiStepTestSuite() {
    ...
    const resAttempt1 = await (0, orchestrator_1.processCase)(case1.id);
    const updatedAttempt1 = await prisma_1.prisma.recoveryCase.findUnique({ where: { id: case1.id }, include: { actions: true } });
    ...
    const resAttempt2 = await (0, orchestrator_1.processCase)(case1.id);
    const updatedAttempt2 = await prisma_1.prisma.recoveryCase.findUnique({ where: { id: case1.id }, include: { actions: true } });
    ...
    const resAttempt3 = await (0, orchestrator_1.processCase)(case1.id);
    const updatedAttempt3 = await prisma_1.prisma.recoveryCase.findUnique({ where: { id: case1.id }, include: { actions: true } });
    ...
    const resAttempt4 = await (0, orchestrator_1.processCase)(case1.id);
    const updatedAttempt4 = await prisma_1.prisma.recoveryCase.findUnique({ where: { id: case1.id } });
    ...
    const resCase2 = await (0, orchestrator_1.processCase)(case2.id);
    assert(resCase2.success === false, 'T2: Re-processing RECOVERED case rejected');
    const obsCase2 = await (0, observationService_1.observeCaseOutcome)(case2.id);
    ...
    process.env.COOLDOWN_MS = '0';
    await (0, orchestrator_1.processCase)(case3.id);
    const updatedCase3_1 = await prisma_1.prisma.recoveryCase.findUnique({ where: { id: case3.id } });
    ...
    await (0, orchestrator_1.processCase)(case3.id);
    const updatedCase3_2 = await prisma_1.prisma.recoveryCase.findUnique({ where: { id: case3.id } });
    ...
    await (0, orchestrator_1.processCase)(case3.id);
    const updatedCase3_3 = await prisma_1.prisma.recoveryCase.findUnique({ where: { id: case3.id } });
    ...
    process.env.COOLDOWN_MS = '0';
    const resCase4 = await (0, orchestrator_1.processCase)(case4.id);
    const updatedCase4 = await prisma_1.prisma.recoveryCase.findUnique({ where: { id: case4.id }, include: { actions: true } });
